...
urlpatterns = [
    ...
    path('update_lesson/<uuid:lesson_id>/', update_lesson, name='update_lesson'),
    path('update-title/', update_title, name='update_title'),
    path('update-quiz/', update_quiz, name='update_quiz'),
    path('save_quiz_data/', save_quiz_data, name='save_quiz_data'),
    path('save_lesson_order/', save_lesson_order, name='save_lesson_order'),
