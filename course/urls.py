...
urlpatterns = [
    ...
    path('course/<uuid:course_id>/lesson/<uuid:lesson_id>/', course_detail_view, name='lesson_detail'),
    path('course/<uuid:course_id>/', course_detail_view, name='course_detail'),
    path('course/<uuid:lesson_id>/', lesson_detail_view, name='lesson_detail'),
